      ...
      custom: function (tooltip) {
        ...
        if (tooltip.body) {
          ...
          titleLines.forEach(function (title, i) {
            innerHtml +=
              '<tr><th><a class="chartjs-tooltip-link" href="https://codeforces.com/contest/' +
              contestRatingResults[tooltip.dataPoints[i].index].contestId +
              '/standings" target="_blank"><strong>' +
              title +
              "</strong></a></th></tr>";
          });
          ...
          bodyLines.forEach(function (body, i) {
            ...
            innerHtml +=
              ...
              span +
              "Rating: " +
              contestRatingResults[tooltip.dataPoints[i].index].newRating +
              " (" +
              (contestRatingResults[tooltip.dataPoints[i].index].newRating -
                contestRatingResults[tooltip.dataPoints[i].index].oldRating >=
              0
                ? "+"
                : "") +
              (contestRatingResults[tooltip.dataPoints[i].index].newRating -
            ...
            innerHtml +=
              ...
              span +
              "Rank: " +
              contestRatingResults[tooltip.dataPoints[i].index].rank +
              "</td></tr>";
          });
          innerHtml += "</tbody>";
